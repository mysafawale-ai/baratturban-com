...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <DynamicContactForm location="India" domain="baratturban.com" />
      <GallerySection />
      <DynamicServicesSection location="India" domain="baratturban.com" />
      <DynamicFooter location="India" domain="baratturban.com" />
      <WhatsAppFloat />
    </main>
  )
}
